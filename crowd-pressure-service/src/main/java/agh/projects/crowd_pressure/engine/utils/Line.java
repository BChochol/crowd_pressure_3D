...
public record Line(Optional<Double> a, Double b) {
    ...
    public static Pair<Line, Line> extendLine(Line line, double width) {
        if (line.a.isPresent()) {
            ...
            return Pair.of(new Line(line.a, line.b - shift), new Line(line.a, line.b + shift));
        } else {
            return Pair.of(new Line(Optional.empty(), line.b - width / 2.0), new Line(Optional.empty(), line.b + width / 2.0));
        }
    }
    ...
    public static Optional<Point> getCrossingPoint(Line line1, Line line2) {
        ...
        } else if (line1.a.isEmpty() && line2.a.isPresent()) {
            double x = line1.b;
